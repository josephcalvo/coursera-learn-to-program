...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['CAT', 'DOG', 'EAT', 'SOT'], 'BOX')
    False 
    """
...
def make_str_from_column(board, column_index):
    ...
    for char in board:
        column = column + char[column_index]
...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'SOAR')
    False
    """
...
def board_contains_word(board, word):
    ...
    True
    >>> board_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'SOAR')
    False
    """
...
def update_score(player_info, word):
    ...
    by adding the point value the word earns to the player's score.
